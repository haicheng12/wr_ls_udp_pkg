...
namespace wr_ls_udp
{
    ...
    CWrLsCommonUdp::CWrLsCommonUdp(const std::string &hostname, const std::string &port, int &timelimit, CParserBase *parser, ros::NodeHandle &nh, ros::NodeHandle &pnh) : CWrLsCommon(parser, nh, pnh),
                                                                                                                                                                           mHostName(hostname),
                                                                                                                                                                           mPort(port),
