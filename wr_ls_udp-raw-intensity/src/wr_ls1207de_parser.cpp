...
namespace wr_ls_udp
{
    CWrLs1207DEParser::CWrLs1207DEParser() : CParserBase(),
                                             fRangeMin(0.05),
                                             fRangeMax(10.0),
                                             fTimeIncrement(-1.0),
                                             fFrame_id("laser")
    ...
    int CWrLs1207DEParser::Parse(char *data, size_t data_length, WrLsConfig &config, sensor_msgs::LaserScan &msg)
    {
        ...
        unsigned short scanning_freq = 1000 / 25 * 100; /*For dev borad, the device will send data every 50ms*/
